...
* [xx ] Change the color of the navigation text to be green.
* [xx ] Utilize `.appendChild()` and `.prepend()` to add two new items to the navigation system. You can call them whatever you want.
* [ ] x your work by looking at the [original html](original.html) in the browser
